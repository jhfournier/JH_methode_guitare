...
\begin{tikzpicture}[scale=1]
	...
	% Strings
	\draw[color=black!50!white, line width=2.0]  (-0.5, 5*\h) -- (\L,5*\h); % E
	\draw[color=black!50!white, line width=2.5]  (-0.5, 4*\h) -- (\L,4*\h); % B
	\draw[color=black!50!white, line width=3.0]  (-0.5, 3*\h) -- (\L,3*\h); % G
	\draw[color=black!50!white, line width=3.5]  (-0.5, 2*\h) -- (\L,2*\h); % D
	\draw[color=black!50!white, line width=4.0]  (-0.5, 1*\h) -- (\L,1*\h); % A
	\draw[color=black!50!white, line width=4.5]  (-0.5, 0*\h) -- (\L,0*\h); % E
	...
	%  position
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (2.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (3.5*\fret,3*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,0*\h) {{\large }};
	
	%  position
	\node[dot=\circ_size, fill=yellow,draw] at (7.5*\fret,4*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow,draw] at (9.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (8.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (9.5*\fret,0*\h) {{\large }};
	
	%  position
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,3*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,2*\h) {{\large }};
