...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (3.5*\fret,2*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (10.5*\fret,3*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (13.5*\fret,0*\h) {{\large }};
