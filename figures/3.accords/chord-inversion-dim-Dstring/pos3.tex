...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (1.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (3.5*\fret,1*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (8.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (7.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (9.5*\fret,1*\h) {{\large R}};
	...
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (12.5*\fret,1*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,0*\h) {{\large }};
	
	% 3nd inversion position
%	\node[dot=\circ_size, fill=yellow!50!red,draw] at (14.5*\fret,5*\h) {{\large R}};
%	\node[dot=\circ_size, fill=yellow!50!red,draw] at (13.5*\fret,4*\h) {{\large }};
%	\node[dot=\circ_size, fill=yellow!50!red,draw] at (14.5*\fret,3*\h) {{\large }};
%	\node[dot=\circ_size, fill=yellow!50!red,draw] at (13.5*\fret,2*\h) {{\large }};
