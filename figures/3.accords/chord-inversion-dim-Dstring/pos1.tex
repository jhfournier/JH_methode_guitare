...
\begin{tikzpicture}[scale=1]
	...
	% Root position
	\node[dot=\circ_size, fill=white,draw] at (5.5*\fret,5*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (8.5*\fret,5*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,5*\h) {{\large }};
