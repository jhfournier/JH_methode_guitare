...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (0.5*\fret,1*\h) {{\large }};
	
	
	% Root position
	\node[dot=\circ_size, fill=white,draw] at (4.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=white,draw] at (2.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=white,draw] at (4.5*\fret,2*\h) {{\large R}};
	\node[dot=\circ_size, fill=white,draw] at (3.5*\fret,1*\h) {{\large }};
	
	% 1st inversion position
	\node[dot=\circ_size, fill=yellow,draw] at (7.5*\fret,4*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow,draw] at (5.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (7.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (6.5*\fret,1*\h) {{\large }};
	
	% 2nd inversion position
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (10.5*\fret, 4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (8.5*\fret,  3*\h) {{\large }};
