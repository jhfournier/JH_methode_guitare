...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (-0.5*\fret,3*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (2.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (1.5*\fret,1*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (6.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (8.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow,draw] at (7.5*\fret,1*\h) {{\large }};
	
	%  position
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (9.5*\fret,3*\h) {{\large }};
