...
\begin{tikzpicture}[scale=1]
	...
	% Anotation (positions)
	\draw[black,anchor=center, text width=3.5cm, align=center] (5,-1) node { {\Large \textbf{E pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (9.5,-1) node { {\Large \textbf{D-C pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (14,-1) node { {\Large \textbf{A pos.} }};
	
	% Rectangle
	\draw [draw=yellow!90!black, line width=1.5] (1.8*\fret,-0.5) rectangle (7.1*\fret,4.5);
	\draw [draw=yellow!50!red!30!white, line width=1.5] (5.8*\fret,+0.4) rectangle (10.2*\fret,4.5);
	\draw [draw=yellow!50!red!80!white, line width=1.5] (8.9*\fret,+0.2) rectangle (15.2*\fret,4.6);
