...
\begin{tikzpicture}[scale=1]
	...
	%\node[dot=\circ_size, fill=white,draw] at (3.5*\fret,2*\h) {{\large 7}};
	%\node[dot=\circ_size, fill=yellow,draw] at (4.5*\fret,2*\h) {{\large R}};
	%\node[dot=\circ_size, fill=yellow,draw] at (3.5*\fret,3*\h) {{\large 3}};
	\node[dot=\circ_size, fill=white,draw] at (2.5*\fret,4*\h) {{\large 5}};
	%\node[dot=\circ_size, fill=white,draw] at (1.5*\fret,5*\h) {{\large 7}};
	\node[dot=\circ_size, fill=white,draw] at (2.5*\fret,5*\h) {{\large R}};
	
	% Arpege (position D-C)
	%\node[dot=\circ_size, fill=white,draw] at (8.5*\fret,1*\h) {{\large 7}};
	...
	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,5*\h) {{\large 3}};
	\node[dot=\circ_size, fill=white,draw] at (9.5*\fret,5*\h) {{\large 5}};
	...
	%\node[dot=\circ_size, fill=white,draw] at (10.5*\fret,3*\h) {{\large 7}};
	%\node[dot=\circ_size, fill=yellow!50!red!80!white,draw] at (11.5*\fret,3*\h) {{\large R}};
	\node[dot=\circ_size, fill=white,draw] at (11.5*\fret,4*\h) {{\large 3}};	
	\node[dot=\circ_size, fill=white,draw] at (14.5*\fret,4*\h) {{\large 5}};
	...
	% Brace
	\draw [decorate, decoration = {brace,amplitude=10pt,raise=5pt}, white,line width=2 ] (8.2,2.4 ) --  (2.5,2.4 )  
	node[white,xshift=3cm,yshift=-1cm]{\Large \textbf{2nd inv.}};
	
	\draw [decorate, decoration = {brace,amplitude=10pt,raise=5pt}, white,line width=2 ] (12.0, 1.8 ) --  (7.2, 1.8 )  
	node[white,xshift=2.5cm,yshift=-1cm]{\Large \textbf{3rd inv.}};
	
	\draw [decorate, decoration = {brace,amplitude=10pt,raise=5pt,aspect=0.4}, white,line width=2 ] (16.5,2.4 ) --  (8.5,2.4 )  
	node[white,xshift=5cm,yshift=-1.5cm]{\Large \textbf{Root pos.}};
	
	\draw [decorate, decoration = {brace,amplitude=10pt,raise=5pt, aspect=0.25}, white,line width=2 ] (18.0, 1.8 ) --  (13, 1.8 )  
	node[white,xshift=4cm,yshift=-1cm]{\Large \textbf{1st inv.}};
