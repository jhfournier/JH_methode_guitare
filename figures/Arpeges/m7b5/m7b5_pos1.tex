...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=red,draw] at (2.5*\fret,0) {{\large \textbf{R}}};
	\node[dot=\circ_size, fill=yellow,draw] at (3.5*\fret,1*\h) {{\normalsize b5}};
	\node[dot=\circ_size, fill=yellow,draw] at (2.5*\fret,2*\h) {{\large m7}};
	\node[dot=\circ_size, fill=red,draw] at (4.5*\fret,2*\h) {{\large \textbf{R}}};
	...
	\node[dot=\circ_size, fill=red,draw] at (2.5*\fret,5*\h) {{\large \textbf{R}}};
