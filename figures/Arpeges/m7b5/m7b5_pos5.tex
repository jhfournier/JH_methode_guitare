...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=red,draw] at (14.5*\fret,0*\h) {{\normalsize \textbf{R}}};
	\node[dot=\circ_size, fill=yellow,draw] at (15.5*\fret,1*\h) {{\normalsize b5}};
	\node[dot=\circ_size, fill=yellow,draw] at (12.5*\fret,1*\h) {{\normalsize m3}};
	\node[dot=\circ_size, fill=yellow,draw] at (14.5*\fret,2*\h) {{\normalsize b7}};
	\node[dot=\circ_size, fill=yellow,draw] at (14.5*\fret,3*\h) {{\normalsize m3}};
	...
	\node[dot=\circ_size, fill=red,draw] at (14.5*\fret,5*\h) {{\normalsize \textbf{R}}};
