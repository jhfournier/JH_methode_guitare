...
\begin{tikzpicture}[scale=1]
	...
	%\node[dot=\circ_size, fill=yellow,draw] at (1.5*\fret,4*\h) {{\large 5}};
	...
	% Anotation (positions)
	\draw[black,anchor=center, text width=3.5cm, align=center] (6,-1) node { {\Large \phantom{\textbf{A pos.}} }};
    \draw[black,anchor=center, text width=3.5cm, align=center] (9,-1) node { {\Large \phantom{\textbf{G-E pos.}} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (14,-1) node { {\Large \phantom{\textbf{D-C pos.}} }};
