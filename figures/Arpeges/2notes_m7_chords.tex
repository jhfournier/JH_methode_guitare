...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=white,draw] at (5.5*\fret,4*\h) {{\normalsize m7}};
	...
	\node[dot=\circ_size, fill=white,draw] at (10.5*\fret,4*\h) {{\large 3}};	
	\node[dot=\circ_size, fill=white,draw] at (14.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=white,draw] at (12.5*\fret,5*\h) {{\normalsize m7}};	
	...
	% Rectangle
	%\draw [draw=yellow!90!black, line width=1.5] (1.8*\fret,2.5) rectangle (7.1*\fret,4.5);
	%\draw [draw=yellow!50!red!30!white, line width=1.5] (5.8*\fret,+2.4) rectangle (10.2*\fret,4.5);
	%\draw [draw=yellow!50!red!80!white, line width=1.5] (8.9*\fret,+2.2) rectangle (15.2*\fret,4.6);
