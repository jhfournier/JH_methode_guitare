...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow,draw] at (13.5*\fret,0*\h) {{\large 7}};
	\node[dot=\circ_size, fill=yellow,draw] at (13.5*\fret,1*\h) {{\large 3}};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (11.5*\fret,4*\h) {{\large 3}};
	\node[dot=\circ_size, fill=yellow,draw] at (14.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow,draw] at (13.5*\fret,5*\h) {{\large 7}};
