...
\begin{tikzpicture}[scale=1]
	...
	% Arpege (position C)
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (9.5*\fret,1*\h) {{\large 1}};
	...
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (6.5*\fret,5*\h) {{\large 3}};
	...
	\node[dot=\circ_size, fill=yellow!50!red!80!white,draw] at (13.5*\fret,5*\h) {{\large 7}};	
	
	% Anotation (positions)
	\draw[black,anchor=center, text width=3.5cm, align=center] (2.2,-1) node { {\Large \textbf{G pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (4.5,-1) node { {\Large \textbf{E pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (8,-1) node { {\Large \textbf{D pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (10,-1) node { {\Large \textbf{C pos.} }};
	\draw[black,anchor=center, text width=3.5cm, align=center] (14,-1) node { {\Large \textbf{A pos.} }};
	
	% Rectangle
	\draw [draw=yellow!90!black, line width=2] (0.8*\fret,-0.5) rectangle (5.2*\fret,4.5);
	\draw [draw=yellow!50!red!30!white, line width=2] (5.8*\fret,+0.4) rectangle (10.2*\fret,4.5);
	\draw [draw=yellow!50!red!80!white, line width=2] (8.9*\fret,+0.2) rectangle (14.2*\fret,4.6);
	
	% Annotation
	\draw[black,anchor=west] (-4cm,2cm) node { {\Huge \textbf{Major}} };
