...
%	% Major scale (fret 11-15)
	\node[dot=\circ_size, fill=red!60!white,   draw] at (11.5*\fret,0) {\textcolor{black}{\large E}};
	\node[dot=\circ_size, fill=red!60!white,draw] at (13.5*\fret,0)    {};
	\node[dot=\circ_size, fill=red!60!white,draw] at (14.5*\fret,0)    {};
	...
	\node[dot=\circ_size, fill=red!60!white,draw] at (11.5*\fret,3*\h) {};
...
%	\node[dot=\circ_size, fill=red!60!white,draw] at (11.5*\fret,4*\h) {};
	...
	\node[dot=\circ_size, fill=red!60!white,draw] at (14.5*\fret,5*\h) {};
%
