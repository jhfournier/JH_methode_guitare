...
%	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,0) {{\large G}};
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (4.5*\fret,0) {\textcolor{black}{\large A}};
%	\node[dot=\circ_size, fill=white,draw] at (1.5*\fret,1*\h) {{\large B}};
%	\node[dot=\circ_size, fill=white,draw] at (2.5*\fret,1*\h) {{\large C}};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,1*\h) {};

%	\node[dot=\circ_size, fill=white,draw] at (1.5*\fret,2*\h) {{\large E}};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (3.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (6.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (7.5*\fret,2*\h) {};

%	\node[dot=\circ_size, fill=white,draw] at (1.5*\fret,3*\h) {{\large A}};
%	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (3.5*\fret,3*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,3*\h) {};

%	\node[dot=\circ_size, fill=white,draw] at (0.5*\fret,4*\h) {{\large C}};
%	\node[dot=\circ_size, fill=white,draw] at (2.5*\fret,4*\h) {{\large D}};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,4*\h) {};
	
%	\node[dot=\circ_size, fill=white,draw] at (1.5*\fret,5*\h) {{\normalsize F}{\tiny $^\#$}};
%	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (2.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,5*\h) {};
	
%	% Major scale (fret 7-10)
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (5.5*\fret,0)    {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (7.5*\fret,0)    {};
...
%	\node[dot=\circ_size, fill=white,draw] at (9.5*\fret,1*\h) {{\large G}};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (6.5*\fret,2*\h) {};
%	\node[dot=\circ_size, fill=white,draw] at (8.5*\fret,2*\h) {{\large B}};
%	\node[dot=\circ_size, fill=white,draw] at (9.5*\fret,2*\h) {{\large C}};

	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (6.5*\fret,3*\h) {};
%	\node[dot=\circ_size, fill=white,draw] at (8.5*\fret,3*\h) {{\large E}};

	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (6.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (7.5*\fret,4*\h) {};
%	\node[dot=\circ_size, fill=white,draw] at (9.5*\fret,4*\h) {{\large A}};

	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (5.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (7.5*\fret,5*\h) {};
