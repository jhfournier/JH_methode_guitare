...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (1.5*\fret,1*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (4.5*\fret,1*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (3.5*\fret,3*\h) {{\large }};

	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,4*\h) {{\large }};
