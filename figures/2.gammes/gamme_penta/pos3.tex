...
%	\node[dot=\circ_size, fill=white,draw] at (4.5*\fret,5*\h) {{\large }};
	...
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,0)    {{\large }};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,1*\h) {{\large }};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,1*\h) {{\large R}};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=cyan,draw] at (8.5*\fret,2*\h) {{\large }};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=cyan,draw] at (8.5*\fret,3*\h) {{\large }};

	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,4*\h) {{\large R}};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,4*\h) {{\large }};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,5*\h) {{\large }};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,5*\h) {{\large }};
