...
%	\node[dot=\circ_size, fill=white, draw] at (4.5*\fret,0) {{\large }};
...
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,1*\h) {{\large }};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,1*\h) {{\large R}};
%
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (8.5*\fret,2*\h) {{\large }};
%
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (8.5*\fret,3*\h) {{\large }};
%
%	\node[dot=\circ_size, fill=white,draw] at (7.5*\fret,4*\h) {{\large R}};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,4*\h) {{\large }};
%
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,5*\h) {{\large }};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,5*\h) {{\large }};
	
	% Major scale (fret 11-15)
	\node[dot=\circ_size, fill=blue!50!red!50!white,   draw] at (11.5*\fret,0)    {{\large }};
%	\node[dot=\circ_size, fill=yellow!70!white,draw] at (14.5*\fret,0)    {{\large R}};
%
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,1*\h) {{\large }};
%	\node[dot=\circ_size, fill=white,draw] at (13.5*\fret,1*\h) {{\large }};
%
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,2*\h) {{\large }};
%	\node[dot=\circ_size, fill=white,draw] at (13.5*\fret,2*\h) {{\large }};
%
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,3*\h) {{\large R}};
%	\node[dot=\circ_size, fill=white,draw] at (13.5*\fret,3*\h) {{\large }};
%
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,4*\h) {{\large }};
%	\node[dot=\circ_size, fill=white,draw] at (14.5*\fret,4*\h) {{\large }};
%
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,5*\h) {{\large }};
