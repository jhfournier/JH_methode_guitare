...
%	\node[dot=\circ_size, fill=blue!50!white,draw] at (7.5*\fret,0)    {{\large C}};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,0) {\textcolor{black}{\large D}};
...
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,1*\h) {{\large E}};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,1*\h) {};

%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,2*\h) {{\large A}};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (8.5*\fret,2*\h) {};
...
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,3*\h) {{\large D}};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (8.5*\fret,3*\h) {};
...
%	\node[dot=\circ_size, fill=white,draw] at (7.5*\fret,5*\h) {{\large C}};
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,5*\h) {};
%
%	% Major scale (fret 11-15)
	\node[dot=\circ_size, fill=blue!50!red!50!white,   draw] at (11.5*\fret,0)    {};
...
%	\node[dot=\circ_size, fill=white,draw] at (14.5*\fret,1*\h) {{\large C}};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,2*\h) {};
%	\node[dot=\circ_size, fill=white,draw] at (13.5*\fret,2*\h) {{\large E}};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,3*\h) {};
%	\node[dot=\circ_size, fill=white,draw] at (13.5*\fret,3*\h) {{\large A}};

	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,4*\h) {};
...
%	\node[dot=\circ_size, fill=white,draw] at (14.5*\fret,4*\h) {{\large D}};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,5*\h) {};
