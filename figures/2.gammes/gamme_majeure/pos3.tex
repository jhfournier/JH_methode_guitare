...
%	% Major scale (fret 7-10)
	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,0)    {\textcolor{cyan}{ \textcolor{black}{\large B}} };
	...
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,1*\h) {};
	...
	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,4*\h) {};
