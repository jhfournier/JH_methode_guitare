...
%	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,0) {{\large G}};
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (4.5*\fret,0) {\textcolor{black}{\large R}};
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (6.5*\fret,0)    {};
	\node[dot=\circ_size, fill=green!60!white!70!black!30!black] at (7.5*\fret,0)    {};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black!30!black] at (3.5*\fret,2*\h) {};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black!30!black] at (4.5*\fret,3*\h) {};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black!30!black] at (6.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (7.5*\fret,4*\h) {};

	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (4.5*\fret,5*\h) {\textcolor{black}{\large }};
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (6.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=green!60!white!70!black!30!black, draw] at (7.5*\fret,5*\h) {};
