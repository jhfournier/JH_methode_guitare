...
%	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,0)    {{\large B}};
...
%	% Major scale (fret 11-15)
	\node[dot=\circ_size, fill=red!60!white,   draw] at (11.5*\fret,0) {\textcolor{black}{\large R}};
	\node[dot=\circ_size, fill=red!60!white!30!white,draw] at (13.5*\fret,0)    {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (14.5*\fret,0)    {\textcolor{black}{\large }};

	\node[dot=\circ_size, fill=red!60!white!30!black] at (11.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (13.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (14.5*\fret,1*\h) {};

	\node[dot=\circ_size, fill=red!60!white,draw] at (11.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!white,draw] at (13.5*\fret,2*\h) {};

	\node[dot=\circ_size, fill=red!60!white!30!black] at (10.5*\fret,3*\h) {};
	\node[dot=\circ_size, fill=red!60!white,draw] at (11.5*\fret,3*\h) {\textcolor{black}{\large R}};
	\node[dot=\circ_size, fill=red!60!white!30!white, draw] at (13.5*\fret,3*\h) {};

	\node[dot=\circ_size, fill=red!60!white,draw] at (11.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!white, draw] at (12.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (14.5*\fret,4*\h) {};

	\node[dot=\circ_size, fill=red!60!white!30!black] at (11.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (13.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=red!60!white!30!black] at (14.5*\fret,5*\h) {\textcolor{black}{\large R}};
%
