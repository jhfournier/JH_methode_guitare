...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=yellow!70!white!30!black] at (1.5*\fret,0) { };
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,0) {\textcolor{black}{\Large R}};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (4.5*\fret,0) {};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (1.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white!30!black] at (2.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (4.5*\fret,1*\h) {};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (1.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white!30!black, draw] at (3.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (4.5*\fret,2*\h) {};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (1.5*\fret,3*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (3.5*\fret,3*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white!30!black] at (4.5*\fret,3*\h) {};

	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (4.5*\fret,4*\h) {};
	
	\node[dot=\circ_size, fill=yellow!70!white!30!black] at (1.5*\fret,5*\h) {};
