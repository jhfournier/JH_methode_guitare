...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=20pt, fill=yellow,draw] at (5.5*\fret,0) {{\large \textcolor{black}{b3}}};    % m3
	\node[dot=20pt, fill=yellow,draw] at (2.5*\fret,1*\h) {{\large \textcolor{black}{4}}};    % 4
	\node[dot=20pt, draw=red, line width=2, fill=yellow, draw] at (3.5*\fret,1*\h) {{\large \textcolor{black}{b5}}};
	...
	\node[dot=20pt, fill=yellow,draw] at (2.5*\fret,3*\h) {{\large \textcolor{black}{b3}}};
	\node[dot=20pt, fill=yellow,draw] at (4.5*\fret,3*\h) {{\large \textcolor{black}{4}}};
	\node[dot=20pt, draw=red, line width=2, fill=yellow, draw] at (5.5*\fret,3*\h) {{\large \textcolor{black}{b5}}};
	...
	\node[dot=20pt, fill=yellow,draw] at (5.5*\fret,5*\h) {{\large \textcolor{black}{b3}}};
