...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, draw=red, line width=2, fill=yellow, draw] at (0.5*\fret,1*\h) {{\large b3}};
	...
	\node[dot=\circ_size, draw=red, line width=2, fill=yellow, draw] at (2.5*\fret,3*\h) {{\large b3}};
