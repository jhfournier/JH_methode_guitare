...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (6.5*\fret,1*\h) {{\large }};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (3.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (4.5*\fret,2*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (6.5*\fret,2*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (7.5*\fret,2*\h) {{\large }};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (4.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (5.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (7.5*\fret,3*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (8.5*\fret,3*\h) {{\large }};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (6.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (7.5*\fret,4*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (9.5*\fret,4*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (10.5*\fret,4*\h) {{\large }};

	\node[dot=\circ_size, fill=yellow!70!white, draw] at (7.5*\fret,5*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white, draw] at (8.5*\fret,5*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (10.5*\fret,5*\h) {{\large }};
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (11.5*\fret,5*\h) {{\large }};
