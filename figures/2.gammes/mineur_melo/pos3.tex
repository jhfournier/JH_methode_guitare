...
%	% Major scale (fret 7-10)
	\node[dot=\circ_size, fill=cyan,draw] at (5.5*\fret,0)    {\textcolor{cyan}{ \textcolor{black}{\large }} };
	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,0)    {};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,0)    {};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (8.5*\fret,1*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,1*\h) {\textcolor{black}{\large R}};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,2*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,2*\h) {};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,3*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (8.5*\fret,3*\h) {};

	\node[dot=\circ_size, fill=cyan,draw] at (6.5*\fret,4*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,4*\h) {\textcolor{black}{\large R}};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,4*\h) {};

	\node[dot=\circ_size, fill=cyan,draw] at (5.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (7.5*\fret,5*\h) {};
	\node[dot=\circ_size, fill=cyan,draw] at (9.5*\fret,5*\h) {};
%
