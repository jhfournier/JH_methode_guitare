...
%	% Major scale (fret 7-10)
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,0) {\textcolor{black}{\large }};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (9.5*\fret,1*\h) {\textcolor{black}{\large R}};
	...
	\node[dot=\circ_size, fill=blue!50!red!50!white,draw] at (11.5*\fret,3*\h) {\textcolor{black}{\large R}};
