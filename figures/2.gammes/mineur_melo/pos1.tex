...
%	\node[dot=\circ_size, fill=yellow!70!white,draw] at (1.5*\fret,0) { };
	...
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (4.5*\fret,2*\h) {\textcolor{black}{\Large R}};
...
%	\node[dot=\circ_size, fill=white,draw] at (0.5*\fret,4*\h) {{\large C}};
	...
	\node[dot=\circ_size, fill=yellow!70!white,draw] at (2.5*\fret,5*\h) {\textcolor{black}{\Large R}};
