...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=green!60!white!70!black, draw] at (4.5*\fret,0) {\textcolor{black}{\large }};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (4.5*\fret,2*\h) {\textcolor{black}{\large R}};
	...
	\node[dot=\circ_size, fill=green!60!white!70!black,draw] at (7.5*\fret,4*\h) {\textcolor{black}{\large R}};
