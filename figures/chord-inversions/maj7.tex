...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (2.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (3.5*\fret,3*\h) {{\large 3}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (3.5*\fret,2*\h) {{\large 7}};
	
	% Root position
	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,5*\h) {{\large 3}};
	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,4*\h) {{\large 7}};
	\node[dot=\circ_size, fill=white,draw] at (6.5*\fret,3*\h) {{\large 5}};
	...
	\node[dot=\circ_size, fill=yellow,draw] at (10.5*\fret,3*\h) {{\large 7}};
	\node[dot=\circ_size, fill=yellow,draw] at (8.5*\fret,2*\h) {{\large 3}};
	
	% 2nd inversion position
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (13.5*\fret,5*\h) {{\large 7}};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,4*\h) {{\large 3}};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,3*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!50!red!30!white,draw] at (11.5*\fret,2*\h) {{\large 5}};
	
	% 3nd inversion position
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (14.5*\fret,5*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (14.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (15.5*\fret,3*\h) {{\large 3}};
	\node[dot=\circ_size, fill=yellow!50!red,draw] at (15.5*\fret,2*\h) {{\large 7}};
