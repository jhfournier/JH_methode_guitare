...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (12.5*\fret,1*\h) {{\large b3}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (10.5*\fret,4*\h) {{\large b3}};
