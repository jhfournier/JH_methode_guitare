...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (2.5*\fret,2*\h) {{\large b}};
	\node[dot=\circ_size, fill=red!80!black,draw] at (4.5*\fret,2*\h) {{\large \textbf{R}}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (2.5*\fret,3*\h) {{\large b3}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (2.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (5.5*\fret,4*\h) {{\large b7}};
	\node[dot=\circ_size, fill=red!80!black,draw=white, line width=1.5pt] at (2.5*\fret,5*\h) {{\large \textbf{R}}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (5.5*\fret,5*\h) {{\large b3}};
