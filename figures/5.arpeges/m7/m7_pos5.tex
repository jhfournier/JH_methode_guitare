...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (12.5*\fret,1*\h) {{\large b3}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (14.5*\fret,3*\h) {{\large b3}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (14.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (12.5*\fret,5*\h) {{\large b7}};
	\node[dot=\circ_size, fill=red!80!black,draw=white, line width=1.5pt] at (14.5*\fret,5*\h) {{\large \textbf{R}}};
%
%	% Annotation
