...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (12.5*\fret,1*\h) {{\large m3}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (14.5*\fret,3*\h) {{\large m3}};
