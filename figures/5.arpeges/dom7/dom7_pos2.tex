...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt ] at (5.5*\fret,4*\h) {{\large m7}};
	\node[dot=\circ_size,  fill=red!80!black,draw] at (7.5*\fret,4*\h) {{\large \textbf{R}}};
