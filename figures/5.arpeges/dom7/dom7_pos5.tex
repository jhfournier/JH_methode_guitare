...
%	\draw[black] (-0.5,0*\h) node { {\Large E} };
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (14.5*\fret,2*\h) {{\large m7}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (12.5*\fret,5*\h) {{\large m7}};
