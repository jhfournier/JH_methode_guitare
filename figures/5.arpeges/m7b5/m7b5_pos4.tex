...
\begin{tikzpicture}[scale=1]
	...
	% Arpege
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (8.5*\fret,0*\h) {{\normalsize b5}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (12.5*\fret,0*\h) {{\normalsize m7}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (12.5*\fret,1*\h) {{\normalsize b5}};
	\node[dot=\circ_size, fill=red!80!black,draw=white, line width=1.5pt] at (9.5*\fret,1*\h) {{\normalsize \textbf{R}}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (10.5*\fret,2*\h) {{\normalsize b5}};
	\node[dot=\circ_size, fill=red!80!black,draw] at (11.5*\fret,3*\h) {{\normalsize \textbf{R}}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (9.5*\fret,3*\h) {{\normalsize m7}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (10.5*\fret,4*\h) {{\normalsize m3}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (12.5*\fret,5*\h) {{\normalsize m7}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (13.5*\fret,4*\h) {{\normalsize b5}};
