...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=red!80!black,draw] at (2.5*\fret,0) {{\large \textbf{R}}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (2.5*\fret,3*\h) {{\normalsize b3}};
	...
	\node[dot=\circ_size, fill=red!80!black,draw] at (2.5*\fret,5*\h) {{\large \textbf{R}}};
