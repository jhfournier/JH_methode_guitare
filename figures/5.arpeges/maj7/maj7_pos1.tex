...
\begin{tikzpicture}[scale=1]
	...
	% Arpege (position E)
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (1.5*\fret,0) {{\large M7}};
	\node[dot=\circ_size, fill=red!80!black,draw=white, line width=1.5pt] at (2.5*\fret,0) {{\large R}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (1.5*\fret,1*\h) {{\large 3}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (3.5*\fret,2*\h) {{\normalsize M7}};
	\node[dot=\circ_size, fill=red!80!black,draw] at (4.5*\fret,2*\h) {{\large R}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (3.5*\fret,3*\h) {{\large 3}};
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (2.5*\fret,4*\h) {{\large 5}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (1.5*\fret,5*\h) {{\normalsize M7}};
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (2.5*\fret,5*\h) {{\large R}};
