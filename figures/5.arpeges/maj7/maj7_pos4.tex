...
\begin{tikzpicture}[scale=1]
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw] at (8.5*\fret,1*\h) {{\large M7}};
	...
	\node[dot=\circ_size, fill=yellow!80!black,draw=white, line width=1.5pt] at (10.5*\fret,3*\h) {{\large M7}};
