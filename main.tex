...
%	\includegraphics[scale=0.55, trim= {0cm 0cm 0cm 0cm}, clip]{gamme_majeure_manche/main.pdf}
	\scalebox{0.5}{\input{figures/gammes/gamme_majeure_manche.tex}}
...
%	\includegraphics[scale=0.55, trim= {0cm 0cm 0cm 0cm}, clip]{gamme_penta_manche/main.pdf}
	\scalebox{0.5}{\input{figures/gammes/gamme_penta_manche.tex}}
...
\begin{figure}[h!]
	\centering
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/blues/blues_penta_mineur.tex}}
%	\vspace{10cm}
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/blues/blues_penta_majeur.tex}}
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/blues/blues_mix_maj_min}}
...
\begin{table}[!h]
	...
	\hspace*{-0cm}
	\scalebox{0.52}{\input{figures/arpeges/m7/m7_pos5.tex}}

	\caption{(left) dom7 arpeggio (EDCAG). (right) m7 arpeggio}
	\label{fig:arpeggio}
\end{table}
...
\begin{table}[!h]
	\hspace*{-4.2cm}
	\scalebox{0.52}{\input{figures/arpeges/maj7/maj7_pos1.tex}}
	\hspace*{-0cm}
