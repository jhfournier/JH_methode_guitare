...
% Table
\input{figures/1.intervalles/table-harmoniques}


 Table
 Source: https://hellomusictheory.com/learn/intervals/
\input{figures/1.intervalles//table-interval}
...
%	\scalebox{0.3}{\input{figures/battement/main.tex}}
	\caption{Beat tone}
	\label{fig:battement}
\end{figure}
...
% Table
\input{figures/2.gammes/table-gammes.tex}
...
\begin{figure}[h!]
    ...
    \begin{tabular}{cc} % two columns
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos1.tex}} &
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos1_penta}} \\[0em]
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos2.tex}} &
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos2_penta}} \\[0em]
		\resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos3.tex}} &
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos3_penta}} \\[0em]
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos4.tex}} &
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos4_penta}} \\[0em]
		\resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos5.tex}} &
        \resizebox{0.8\textwidth}{!}{\input{figures/2.gammes/majeure/pos5_penta}} \\[0em]
    \end{tabular}
...
% Figure: gamme mineur mélodique
\begin{figure}[h!]
	\centering
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_melo/pos1.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_melo/pos2.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_melo/pos3.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_melo/pos4.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_melo/pos5.tex}}
	\caption{G melodic minor scale on the fretboard position 1, 2, 3, 4 and 5.}
	\label{fig:gamme_mineur_melo}
\end{figure}

% Figure: gamme mineur harmonique
\begin{figure}[h!]
	\centering
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_harmo/pos1.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_harmo/pos2.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_harmo/pos3.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_harmo/pos4.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/mineur_harmo/pos5.tex}}
...
\begin{figure}[h!]
	\centering
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/diminue/pos1.tex}}
	\hspace*{-2cm}
	\scalebox{0.5}{\input{figures/2.gammes/diminue/pos2.tex}}
...
\input{figures/3.accords/table-accords.tex}
...
% Figure: chord inversion on D string
\begin{figure}[h!]
	\centering
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Dstring/Dom7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Dstring/m7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Dstring/maj7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Dstring/m7b5.tex}}
	\caption{Chord inversion on the D string. (a) dom7 chords. (b) m7 chords. (c) maj7 chords. (d) m7b5 chords }
	\label{fig}
\end{figure}

% Figure: chord inversion on A string
\begin{figure}[h!]
	\centering
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Astring/Dom7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Astring/m7.tex}}
	\hspace*{-2.2cm}
%	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Astring/maj7.tex}}
	\hspace*{-2.2cm}
%	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Astring/m7b5.tex}}
	\caption{Chord inversion on the A string. (a) dom7 chords. (b) m7 chords (drop 2) . (c) maj7 chords. (d) m7b5 chords }
	\label{fig}
\end{figure}

% Figure chord inversion on E string
\begin{figure}[h!]
	\centering
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Estring/Dom7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Estring/m7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Estring/maj7.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversions-Estring/m7b5.tex}}
...
\begin{figure}[h!]
	\centering
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversion-dim-Dstring/pos1.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversion-dim-Dstring/pos2.tex}}
	\hspace*{-2.2cm}
	\scalebox{0.7}{\input{figures/3.accords/chord-inversion-dim-Dstring/pos3.tex}}
...
% Table
% Source: 1997 - Vaillot Méthode Jazz
\input{figures/4.harmonie/Progression_accord.tex}
...
\begin{figure}[!h]
	...
	\hspace*{-0cm}
	\scalebox{0.52}{\input{figures/5.arpeges/m7/m7_pos5.tex}}
...
\begin{figure}[!h]
	\hspace*{-4.2cm}
	\scalebox{0.52}{\input{figures/5.arpeges/maj7/maj7_pos1.tex}}
	\hspace*{-0cm}
...
\begin{figure}[!h]
	...
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/6.blues/gammes/blues_penta_majeur.tex}}
	\hspace*{-1cm}
...
\begin{figure}[!h]
    \centering
	\hspace*{0cm}
	\scalebox{1.5}{\input{figures/6.blues/blues_progression1.tex}}
	\scalebox{1.5}{\input{figures/6.blues/blues_progression2.tex}}
	\scalebox{1.5}{\input{figures/6.blues/blues_progression3.tex}}
