...
\begin{figure}[h!]
	\centering
	\hspace*{0cm}
	\includegraphics[scale=0.5, trim= {0cm 0cm 0cm 0cm}, clip]{figures/1.intervals/battement/main.pdf}
...
%	\includegraphics[scale=0.55, trim= {0cm 0cm 0cm 0cm}, clip]{gamme_penta_manche/main.pdf}
	\scalebox{0.5}{\input{figures/2.gammes/gamme_penta_manche.tex}}
...
% Figure
% ref: https://www.jazzguitar.be/blog/blues-scales/
\begin{figure}[h!]
	\centering
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/2.gammes/blues_penta_mineur.tex}}
%	\vspace{10cm}
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/2.gammes/blues_penta_majeur.tex}}
	\hspace*{-1cm}
	\scalebox{0.7}{\input{figures/2.gammes/blues_mix_maj_min}}
...
\begin{figure}[h!]
	\centering
	\hspace*{-2.2cm}
	\includegraphics[scale=0.7, trim= {0cm 0cm 0cm 0cm}, clip]{figures/3.accords/chord-inversions/maj7.tex}
	\hspace*{-2.2cm}
	\includegraphics[scale=0.7, trim= {0cm 0cm 0cm 0cm}, clip]{figures/3.accords/chord-inversions/Dom7.tex}
	\hspace*{-2.2cm}
	\includegraphics[scale=0.7, trim= {0cm 0cm 0cm 0cm}, clip]{figures/3.accords/chord-inversions/m7.tex}
